...
class DomainAvailabilityApiError(Exception):
...
class ParameterError(DomainAvailabilityApiError):
    pass


class EmptyApiKeyError(DomainAvailabilityApiError):
    pass


class ResponseError(DomainAvailabilityApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(DomainAvailabilityApiError):
...
class HttpApiError(DomainAvailabilityApiError):
    pass
